...
public class ToiletVO {
	String pt_city, pt_kind, pt_addr1, pt_addr2;
	int pt_m_handi1, pt_m_handi2, pt_f_handi;
	...
	public int getPt_f_handi() {
		return pt_f_handi;
	}
	public void setPt_f_handi(int pt_f_handi) {
	...
	public String toString() {
		return "ToiletVO [pt_city=" + pt_city + ", pt_kind=" + pt_kind + ", pt_addr1=" + pt_addr1 + ", pt_addr2="
				+ pt_addr2 + ", pt_m_handi1=" + pt_m_handi1 + ", pt_m_handi2=" + pt_m_handi2 + ", pt_f_handi="
				+ pt_f_handi + ", pt_tel=" + pt_tel + ", pt_time=" + pt_time + ", pt_lat=" + pt_lat + ", pt_lng="
				+ pt_lng + "]";
	}
